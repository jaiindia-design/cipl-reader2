...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `You are an expert data extraction assistant specializing in handwritten documents.
Carefully analyze the attached Goods Receipt Note (GRN) image.
